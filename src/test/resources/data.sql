INSERT INTO Organization (id, version, name, full_name, inn, kpp, address, phone, is_active) VALUES  (1, 1, 'test_org name', 'test_org full_name', '1111111111', '2222222222', 'test_org adress', '71111111111', true),
...
INSERT INTO User (id, version, first_name, second_name, middle_name, position, phone, is_identified, office_id, country_id) VALUES  (1, 1, 'test_user first_name', 'test_user second_name', 'test_user middle_name', 1, '75555555555', true, 1, 643),
                                                                                                                                (2, 1, 'test_user first_name2', 'test_user second_name2', 'test_user middle_name2', 1, '75555555555', true, 2, 643);
