...
public interface OfficeMapper {
    ...
    Office toModel(OfficeSaveRequestDto officeSaveRequestDto, Organization organization);
    ...
    Office toModel(OfficeListRequestDto officeListRequestDto, Organization organization);
