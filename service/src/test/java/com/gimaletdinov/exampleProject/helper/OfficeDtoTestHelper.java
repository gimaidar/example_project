...
public class OfficeDtoTestHelper {
    ...
    public static OfficeUpdateRequestDto getPopulateOfficeUpdateRequestDto() {
        ...
        officeUpdateRequestDto.setId(TEST_UPDATED_OFFICE_ID);
        officeUpdateRequestDto.setName(TEST_UPDATED_OFFICE_NAME);
        officeUpdateRequestDto.setAddress(TEST_UPDATED_OFFICE_ADDRESS);
        officeUpdateRequestDto.setPhone(TEST_UPDATED_OFFICE_PHONE);
        officeUpdateRequestDto.setIsActive(TEST_UPDATED_OFFICE_IS_ACTIVE);
