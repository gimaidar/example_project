...
public class OrganizationDtoTestHelper {
    ...
    public static OrganizationUpdateRequestDto getPopulateOrganizationUpdateRequestDto() {
        ...
        organizationUpdateRequestDto.setName(TEST_UPDATED_ORG_NAME);
        organizationUpdateRequestDto.setFullName(TEST_UPDATED_ORG_FULL_NAME);
        organizationUpdateRequestDto.setInn(TEST_UPDATED_ORG_INN);
        organizationUpdateRequestDto.setKpp(TEST_UPDATED_ORG_KPP);
        organizationUpdateRequestDto.setAddress(TEST_UPDATED_ORG_ADDRESS);
        organizationUpdateRequestDto.setPhone(TEST_UPDATED_ORG_PHONE);
        organizationUpdateRequestDto.setIsActive(TEST_UPDATED_ORG_IS_ACTIVE);
